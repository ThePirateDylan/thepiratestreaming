...
from bingie.parser import try_int, merge_two_dicts
from infotagger.listitem import ListItemInfoTag
from tmdbbingiehelper.lib.addon.consts import ACCEPTED_MEDIATYPES, PARAM_WIDGETS_RELOAD, PARAM_WIDGETS_RELOAD_FORCED
from tmdbbingiehelper.lib.addon.plugin import ADDONPATH, PLUGINPATH, convert_media_type, get_setting, get_condvisibility, get_localized, encode_url, get_flatseasons_info_param, GlobalSettingsDict
from tmdbbingiehelper.lib.addon.tmdate import is_unaired_timestamp
from tmdbbingiehelper.lib.addon.logger import kodi_log
from bingie.window import get_property

""" Lazyimports
from tmdbbingiehelper.lib.items.context import ContextMenu
"""
...
class _Video(_ListItem):
    ...
    def _set_params_reroute_default(self):
        ...
        self.context_menu.insert(0, (
            '$ADDON[plugin.video.tmdb.pirate.helper 32322]',
    ...
    def _set_contextmenu_choosedefault(self, tmdb_type, tmdb_id, season=None, episode=None):
        ...
        self.context_menu.append((
            '$ADDON[plugin.video.tmdb.pirate.helper 32476]',
            f'Runscript(plugin.video.tmdb.pirate.helper,{path})',))

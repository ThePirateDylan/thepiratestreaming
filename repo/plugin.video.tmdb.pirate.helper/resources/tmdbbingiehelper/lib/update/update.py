...
from tmdbbingiehelper.lib.addon.plugin import get_setting, get_localized
from bingie.parser import try_int
from tmdbbingiehelper.lib.files.futils import validify_filename, make_path, write_to_file, get_tmdb_id_nfo
from tmdbbingiehelper.lib.api.trakt.api import TraktAPI
from tmdbbingiehelper.lib.api.mdblist.api import MDbList
from tmdbbingiehelper.lib.addon.logger import kodi_log


STRM_MOVIE = 'plugin://plugin.video.tmdb.pirate.helper/?info=play&tmdb_id={}&tmdb_type=movie&islocal=True'
STRM_EPISODE = 'plugin://plugin.video.tmdb.pirate.helper/?info=play&tmdb_type=tv&islocal=True&tmdb_id={}&season={}&episode={}'
BASEDIR_MOVIE = get_setting('movies_library', 'str') or 'special://profile/addon_data/plugin.video.tmdb.pirate.helper/movies/'
BASEDIR_TV = get_setting('tvshows_library', 'str') or 'special://profile/addon_data/plugin.video.tmdb.pirate.helper/tvshows/'
NFOFILE_MOVIE = u'movie-tmdbbingiehelper' if get_setting('alternative_nfo') else u'movie'
NFOFILE_TV = u'tvshow-tmdbbingiehelper' if get_setting('alternative_nfo') else u'tvshow'
"""

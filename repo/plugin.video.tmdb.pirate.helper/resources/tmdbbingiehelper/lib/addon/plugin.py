import re
import xbmc
import bingie.plugin
import bingie.parser
from tmdbbingiehelper.lib.addon.consts import LANGUAGES
""" Top level module only import constants """


KODIPLUGIN = bingie.plugin.KodiPlugin('plugin.video.tmdb.pirate.helper')
...
PLUGINPATH = u'plugin://plugin.video.tmdb.pirate.helper/'

get_setting = KODIPLUGIN.get_setting
set_setting = KODIPLUGIN.set_setting
get_localized = KODIPLUGIN.get_localized

encode_url = bingie.parser.EncodeURL(u'plugin://plugin.video.tmdb.pirate.helper/').encode_url
...
format_name = bingie.plugin.format_name
format_folderpath = bingie.plugin.format_folderpath

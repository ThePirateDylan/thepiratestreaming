...
from tmdbbingiehelper.lib.addon.plugin import get_setting, format_name, get_localized
import bingie.logger as bingie_logger


LOGGER = bingie_logger.Logger(
    log_name='[plugin.video.tmdb.pirate.helper]\n',
    notification_head=f'TMDb Bingie Helper {get_localized(257)}',
...
TimerList = bingie_logger.TimerList
TimerFunc = bingie_logger.TimerFunc
...
class CProfiler():
    ...
    def __exit__(self, exc_type, exc_value, exc_traceback):
        ...
        import io
        import pstats
        from tmdbbingiehelper.lib.files.futils import write_to_file

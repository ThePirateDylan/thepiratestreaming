...
NODE_BASEDIR = 'special://profile/addon_data/plugin.video.tmdb.pirate.helper/nodes/'
...
PLAYERS_BASEDIR_USER = 'special://profile/addon_data/plugin.video.tmdb.pirate.helper/players/'
PLAYERS_BASEDIR_SAVE = 'special://profile/addon_data/plugin.video.tmdb.pirate.helper/reconfigured_players/'
PLAYERS_BASEDIR_BUNDLED = 'special://home/addons/plugin.video.tmdb.pirate.helper/resources/players/'
PLAYERS_BASEDIR_TEMPLATES = 'special://home/addons/plugin.video.tmdb.pirate.helper/resources/templates/'
...
PARAM_WIDGETS_RELOAD = 'reload=$INFO[Window(Home).Property(TMDbBingieHelper.Widgets.Reload)]'
...
RANDOMISED_LISTS_ROUTE = {
    'module_name': 'tmdbbingiehelper.lib.items.randomdir',
...
TMDB_COMBO_LISTS_ROUTE = {
    'module_name': 'tmdbbingiehelper.lib.api.tmdb.lists',
...
TRAKT_BASIC_LISTS_ROUTE = {
    'module_name': 'tmdbbingiehelper.lib.api.trakt.lists',
    'import_attr': 'ListBasic'}
TRAKT_BASIC_LISTS = {
    'trakt_trending': {
...
TRAKT_SYNC_LISTS = {
    ...
    'trakt_watchlist_released': {
        ...
        'filters': {
            ...
            'filter_value': {
                'module': 'tmdbbingiehelper.lib.addon.tmdate',
...
MDBLIST_LIST_OF_LISTS_ROUTE = {
    'module_name': 'tmdbbingiehelper.lib.api.mdblist.lists',
    'import_attr': 'ListLists'}
...
ROUTE_NOID = {
    'dir_search': {'route': {
        'module_name': 'tmdbbingiehelper.lib.api.tmdb.search',
    ...
    'dir_discover': {'route': {
        'module_name': 'tmdbbingiehelper.lib.api.tmdb.discover',
    ...
    'library_airingnext': {'route': {
        'module_name': 'tmdbbingiehelper.lib.api.tmdb.lists_airingnext',
    ...
    'dir_tvdb_awards': {'route': {
        'module_name': 'tmdbbingiehelper.lib.api.tvdb.lists_awards',
    ...
    'dir_tvdb_genres': {'route': {
        'module_name': 'tmdbbingiehelper.lib.api.tvdb.lists_genres',
        'import_attr': 'ListGenres'}},
    'tvdb_genre': {'route': {
        'module_name': 'tmdbbingiehelper.lib.api.tvdb.lists_genres',
...
ROUTE_TMDBID = {
    'details': {'route': {
        'module_name': 'tmdbbingiehelper.lib.items.basedir',

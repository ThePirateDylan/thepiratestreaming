...
from bingie.tmdate import get_timestamp, set_timestamp
from bingie.plugin import KodiPlugin
from bingie.bcache import BasicCache

KODIPLUGIN = KodiPlugin('script.module.pirate')

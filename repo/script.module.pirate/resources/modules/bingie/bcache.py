from bingie.plugin import format_name
from bingie.futils import get_filecache_name
from bingie.logger import kodi_try_except_internal_traceback
import bingie.scache


class BasicCache():
    _simplecache = bingie.scache.SimpleCache
    _queue_limit = 20
    ...
    def kodi_traceback(exc, log_msg):
        ...
        from bingie.logger import Logger
        Logger(
            log_name='[script.module.pirate]\n',
